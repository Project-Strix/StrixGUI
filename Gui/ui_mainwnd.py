...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.imageLoaderPushButton = QPushButton(self.centralwidget)
        self.imageLoaderPushButton.setObjectName(u"imageLoaderPushButton")

        self.gridLayout_2.addWidget(self.imageLoaderPushButton, 0, 0, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.imageLoaderPushButton.setText(QCoreApplication.translate("MainWindow", u"DataPreprocessSetup", None))
